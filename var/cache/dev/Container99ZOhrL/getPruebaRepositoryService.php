...
// Returns the private 'App\Repository\PruebaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PruebaRepository.php';

return $this->privates['App\\Repository\\PruebaRepository'] = new \App\Repository\PruebaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
