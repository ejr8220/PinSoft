...
use App\Service\UsuarioLoginService;
...
{
    private $usuarioLoginService;
    private $aplicacionService;
    private $usuario_aplicacionService;
    private $tokenService;
    public function __construct(UsuarioLoginService $serviceUsuarioLogin, AplicacionService $serviceAplicacion,
                                Usuario_AplicacionService $serviceUsuario_Aplicacion, 
                                TokenService $serviceToken)
    {
        $this->usuarioLoginService = $serviceUsuarioLogin;
        ...
        try 
        {
            switch ($strOp)
            {
                case 'usuarioLogin':
                    ...
                    $arrayRespuesta = $this->usuarioLoginService->mainUsuarioLogin($arrayRequest['data']);
